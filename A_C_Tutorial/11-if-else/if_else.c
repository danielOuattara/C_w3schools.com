...
-----------------------------
You learned from the operators comparison chapter, that C language supports
...
Note : "if" is in lowercase letters.
  ...
  is false.Because of this, we move on to the else condition and print to
  the screen "Good evening".If the time was less than 18, the program would
  print "Good day".
  ...
  */
  ...
  /*You can simply write : int time = 20; */
  time = 20;
  (time < 18) ? printf("\nGood day.") : printf("\nGood evening.");
